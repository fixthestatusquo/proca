    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          return [
            4 /*yield*/,
            api_1.request(api, api_1.admin.CopyActionPageDocument, {
              fromName: fn,
              toName: tn,
              toOrg: org,
            }),
        ...
        case 1:
          ...
          if (data && data.copyActionPage) {
            ...
            return [
              2 /*return*/,
              __assign(__assign({}, data.copyActionPage), {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          return [
            4 /*yield*/,
            api_1.request(api, api_1.admin.DashOrgOverviewDocument, {
              org: org,
            }),
          ];
        case 1:
          ...
          if (data && data.org) {
            return [
              2 /*return*/,
              __assign(__assign({}, data.org), {
                config: JSON.parse(data.org.config),
              }),
            ];
          }
          return [2 /*return*/];
...
var updateConfig = function (apId, cfg) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            api_1.request(api, api_1.admin.UpdateActionPageDocument, {
              id: apId,
        ...
        case 1:
          ...
          if (
            data &&
            ((_b = data.updateActionPage) === null || _b === void 0
              ? void 0
              : _b.id)
          ) {
            console.log(
              "Updated the ap id ",
              (_c = data.updateActionPage) === null || _c === void 0
                ? void 0
                : _c.id
            );
          } else {
...
var addPartner = function (genericPage, partnerOrg) {
  return __awaiter(void 0, void 0, void 0, function () {
    var newAp, org, cfg;
    var _a, _b;
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          return [
            4 /*yield*/,
            copy(genericPage, partnerOrg, pickName(genericPage, partnerOrg)),
          ];
        case 1:
          newAp = _c.sent();
        ...
        case 2:
          ...
          if (!cfg || !cfg.component || !cfg.component.consent || !cfg.layout) {
            console.error(
              "this config does not have component.consent or layout",
              cfg
            );
          ...
          // priv policy
          if (
            (_a = org.config.privacy) === null || _a === void 0
              ? void 0
              : _a.policyUrl
          )
          ...
          // color
          if (
            (_b = org.config.brand) === null || _b === void 0
              ? void 0
              : _b.primaryColor
          )
