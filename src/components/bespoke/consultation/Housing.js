...
<SingleSelect form={form} label=" " name={k} options={"campaign:questions."+k+".options"} select="key"/>

      </FormControl>
            )}


    return (<MultiSelect form={form} label={questions[k].question} name={k} options={questions[k].options} key={k}/>);
})
}
