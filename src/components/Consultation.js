...
console.log("go to step ", step);
    ...
    if (step < activeStep) { // Allow going back, but restrict jumping ahead
      setActiveStep(step);
    }
  };
  ...
  const prepareData = () => {console.log("prepareData")};
...
return (
<>
      <Stepper activeStep={activeStep} alternativeLabel style={{ width: '100%' }} nonLinear>
